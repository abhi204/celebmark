...
import UserSignupForm from './user_signup_form';
import {
  Button,
  Checkbox,
  Form,
...
const panes = [
  ...
  {
    menuItem:{ key: 'celebSignup', icon: 'youtube play', content: 'Celeb Signup', color: 'red' },
    render: () => <Tab.Pane>
                    <Container>
                      <div>< br/>
                        <Header as='h2' icon textAlign='center'>
                          <Icon name='youtube play' color='red' circular />
